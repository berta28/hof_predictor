...
* In the "Model" tab, click the "Build Model" button to train a logistic regression model with the selected features.
* View the model summary and coefficients to understand the impact of each feature on the prediction.
